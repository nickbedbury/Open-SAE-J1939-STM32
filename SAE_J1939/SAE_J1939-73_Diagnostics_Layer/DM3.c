...
ENUM_J1939_STATUS_CODES SAE_J1939_Send_Request_DM3(CAN_HandleTypeDef *CanHandle, uint32_t *TxMailbox, J1939 *j1939, uint8_t DA) {
	return SAE_J1939_Send_Request(CanHandle, TxMailbox, j1939, DA, PGN_DM3);
}
...
ENUM_J1939_STATUS_CODES SAE_J1939_Response_Request_DM3(CAN_HandleTypeDef *CanHandle, uint32_t *TxMailbox, J1939* j1939, uint8_t DA) {
	...
	return SAE_J1939_Response_Request_DM2(CanHandle, TxMailbox, j1939, DA);					/* Send DM2 codes to the ECU who send the request */
}
